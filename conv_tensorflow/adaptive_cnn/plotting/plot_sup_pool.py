...
log_dir = 'logs_to_plot' + os.sep + 'sup-pool'
...
file_name = os.path.join(log_dir, 'data_distribution_svhn-10 non-stationary.log')
...
file_name = os.path.join(log_dir, 'svhn10-pool_distribution.log')
    ...
    for line in f:
        if line.startswith('#'):
            ...
            if x_val*500>=10000:
                ...
                s10_pool_x_axis.append(x_val*500 - 10000)
            x_val += 1
...
ax1.set_title('Training Data Distribution (SVHN10-Nonstationary) (1 Epoch)',fontsize=fontsize_title,y=1.05)
...
ax2.set_xlim([0,s10_pool_x_axis[-1]])
ax2.set_ylim([0,1.0])
ax2.set_xlabel('Time (t)',fontsize=fontsize_label)
ax2.set_title('Data distribution of $B_{pool}$ (SVHN10-Nonstationary) (6 Epochs)',fontsize=fontsize_title,y=1.05)
