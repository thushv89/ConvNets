...
operations = ['cifar10_nonstationary','cifar100_nonstationary']
...
if 'cifar10_nonstationary' in operations:
    file_names = [os.path.join(log_dir, 'Error_cifar10_inc_nonstationary.log'),
                  os.path.join(log_dir, 'Error_cifar10_noninc_nonstationary.log')]
