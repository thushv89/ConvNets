        ...
        for value in tuning_set:
            ...
            if hyparam == 'l2_beta':
                if value is None:
                    ...
                    sub_dir_string += 'l2_%.1f' % value
                    include_l2_loss = True
                    beta = value
            else:
                sub_dir_string += 'l2_%.1f' % best_l2beta
                include_l2_loss = True
                beta = best_l2beta
            ...
            if hyparam == 'lrn_alpha':
                sub_dir_string += 'lrn_alp_%.4f' % value
                lrn_alpha = value
            else:
                sub_dir_string += 'lrn_alp_%.4f' % best_lrn_alpha
