...
def load_and_save_data_cifar10(directory,filename,**params):

    valid_size_required = 10000
    cifar_file = directory+os.sep+filename

    if os.path.exists(cifar_file):
        return

    train_pickle_file = directory+os.sep+'cifar_10_data_batch_'
    test_pickle_file = directory+ os.sep + 'cifar_10_test_batch'
    train_raw = None
    test_dataset = None
...
def reformat_data_cifar10(directory,filename,**params):
    ...
    print("Reformatting data ...")
    cifar10_file = directory+os.sep+filename
