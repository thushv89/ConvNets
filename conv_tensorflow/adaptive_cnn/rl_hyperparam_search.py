...
if __name__=='__main__':
    ...
    rl_learning_rates = [0.1,0.01,0.005,0.001]
    rl_discounts = [0.9,0.7,0.5]
    rl_hiddenlayers = [[128],[128,64],[128,64,32]]
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        for hyparam in ['discount_rate','learning_rate','hidden_layers']:
            testing_hyparam_options = None
            best_learning_rate = rl_learning_rates[0]
            best_discount = rl_discounts[0]
            best_hidden = rl_hiddenlayers[0]
            ...
            for value in testing_hyparam_options:
                ...
                sub_output_dir = os.path.join(output_dir,sub_dir_string)
                ...
                if research_parameters['adapt_structure']:
                    ...
                    if hyparam == 'discount_rate':
                        ...
                        adapter = qlearner.AdaCNNAdaptingQLearner(
                            ...
                            session=session, random_mode=False,
                            state_history_length=state_history_length,
                            hidden_layers=value, momentum=0.9, learning_rate=best_hidden
                        )
